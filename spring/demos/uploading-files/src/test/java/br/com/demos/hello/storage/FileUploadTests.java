...
public class FileUploadTests {
    ...
    public void shouldListAllFiles() throws Exception {
        ...
        this.mvc.perform(get("/file/")).andExpect(status().isOk())
                .andExpect(model().attribute("files",
                        Matchers.contains("http://localhost/file/files/first.txt",
                                "http://localhost/file/files/second.txt")));
    }
    ...
    public void should404WhenMissingFile() throws Exception {
        ...
        this.mvc.perform(get("/file/files/test.txt")).andExpect(status().isNotFound());
    }
